...
<html>
	...
	<body>
		<a href="#edit-kitchen" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-kitchen" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${kitchenInstance?.version}" />
				<fieldset class="form">
